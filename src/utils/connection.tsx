...
export const THEME = [
  {
    name: "https://raw.githubusercontent.com/Pyca-cc/pycaswap/main/src/components/assets/theme/eclipse.jpg",
  },
  {
    name: "black",
  },
...
const DEFAULT_THEME = THEME[0].name;
...
export function ConnectionProvider({ children = undefined as any }) {
  ...
  useEffect(() => {
    ...
    window
      ...
      .fetch(
        `https://raw.githubusercontent.com/Pyca-cc/pycaswap/main/token-list/${env}.json`
      )
      .then((res) => {
        return res.json();
      })
